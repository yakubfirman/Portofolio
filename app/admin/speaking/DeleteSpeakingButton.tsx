...
export default function DeleteSpeakingButton({ id, title }: { id: number; title: string }) {
  ...
  return (
    <button
      ...
      disabled={pending}
      className="flex items-center gap-1.5 rounded border border-red-200 px-2 py-1.5 text-xs text-red-800 transition-colors hover:border-red-800/50 hover:text-red-700 disabled:opacity-50 sm:px-3"
    >
      {pending ? (
